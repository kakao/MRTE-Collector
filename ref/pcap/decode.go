...
func (arp *Arphdr) IsUserData() bool { return false }
...
func (ip *Iphdr) IsUserData() bool { return false }
...
func (tcp *Tcphdr) IsUserData() bool {
...
func (tcp *Tcphdr) SrcAddr() string  { return string(tcp.SrcPort) }
func (tcp *Tcphdr) DestAddr() string { return string(tcp.DestPort) }
...
func (udp *Udphdr) IsUserData() bool { return false }
...
func (icmp *Icmphdr) IsUserData() bool { return false }
...
func (ip6 *Ip6hdr) IsUserData() bool { return false }
